...
new Promise(inputANumberExecutor)
  .this(mustBeGreaterThanZero()) // is the number greater than zero?
  .this(logSuccessFailure()) // is the number even?
  .this(isEvenNumber) // log the success/failure of the user's input
